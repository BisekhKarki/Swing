...
public static void dataStudent() {
    ...
    try {
           ...
           String q = "select * from courses.student";
           ...
           while(r.next()){
        	   ...
        	   String level = r.getString(9);
        	  
        	   String data[]= {id,first_name, last_name, email,course,level};
        	   m.addRow(data);
...
public static void courseSearchEnter(String course) {
    ...
    try {
           Connection con = DriverManager.getConnection(url, baseUsername, basePassword);
           Statement stmt = con.createStatement();
           String query = "select * from courses.Course WHERE Course_Name ='"+enteredText+"'";
           ResultSet rs = stmt.executeQuery(query);   
           while(rs.next()){
        	   String id = rs.getString(1);
        	   String course_name = rs.getString(2);
...
public static void tutorSearchEnter(String tutor) {
    ...
    try {
           Connection con2 = DriverManager.getConnection(url, baseUsername, basePassword);
           Statement stmt2 = con2.createStatement();
           String query2 = "select * from courses.teacher where First_Name='"+teacher+"'";
           ResultSet rs2 = stmt2.executeQuery(query2);
           while(rs2.next()){
        	   String id = rs2.getString(1);
        	   String firstName = rs2.getString(2);
...
public static String TotalColumns(String tableName) {
	...
	public Dashboard() {
		...
		dashboardBtn.setBounds(22, 153, 190, 57);
		...
		coursesBtn.setBounds(22, 240, 190, 57);
		...
		tutorBtn.setBounds(22, 329, 190, 57);
		panel.add(tutorBtn);
		...
		studentBtn.setBounds(22, 412, 190, 57);
		...
		settingBtn.setBounds(22, 500, 190, 57);
		...
		logoutBtn.setBounds(22, 584, 190, 52);
		panel.add(logoutBtn);
		...
		lblNewLabel.setBounds(20, 12, 192, 119);
		...
		btnAddCourse.setBackground(new Color(222, 221, 218));
		...
		btnEditCourse.setBackground(new Color(222, 221, 218));
		...
		btnDeleteCourse.setBackground(new Color(222, 221, 218));
		...
		btnAddTutors.setBackground(new Color(222, 221, 218));
...
;				ta.setVisible(true);
		...
		btnUpdateTutors.setBackground(new Color(222, 221, 218));
		...
		studentDataTable.setModel(new DefaultTableModel(
			...
			new String[] {
					"ID", "First_Name", "Last_Name", "Email", "Course","level"
			}
		));
		...
		studentAdd.setBackground(new Color(222, 221, 218));
		...
		btnEditStudent.setBackground(new Color(222, 221, 218));
		...
		btnDeleteStudent.setBackground(new Color(222, 221, 218));
...
//				String userMail = Login.mail();
		...
		passChange.setBackground(new Color(222, 221, 218));
