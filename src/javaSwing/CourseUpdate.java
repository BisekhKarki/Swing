...
public void updatingCourse(String courseID, String courseName, String moduleName, String batch, String seats, String studyYear) {
    ...
    try {
        ...
        String createTable = "CREATE TABLE IF NOT EXISTS courses.Course(ID INT AUTO_INCREMENT PRIMARY KEY,Course_Name varchar(100), Seats varchar(1000), Batch varchar(1000), No_of_Years varchar(120), Module varchar(1000))";

//      Execute the SQL statement to create the table

        s.executeUpdate(createTable);

        String updateQuery = "UPDATE courses.Course SET "
                + "Course_Name = '" + name + "', "
                + "Seats = '" + seatNumber + "', "
                + "Batch = '" + group + "', "
                + "No_of_Years = '" + year + "' ,"
