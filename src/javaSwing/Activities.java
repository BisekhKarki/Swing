...
public static void activity() {
    ...
    try {
        ...
        String activityTable = "CREATE TABLE IF NOT EXISTS courses.activity(ID INT AUTO_INCREMENT PRIMARY KEY, Activities varchar(500))";
    	s.execute(activityTable);
    	
    	String time = currentTime();
    	String activity = "logged in by:'"+user+"' ,email: '"+email+"' at '"+time+"'";
    	String inserting = "INSERT INTO courses.activity (Activities) VALUES (?)";
