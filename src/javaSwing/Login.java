...
public class Login extends JFrame {
	...
	public Login() {
		...
		JLabel lblLoginPage = new JLabel("Welcome To Login Page");
		...
		loginBtn.setBounds(429, 257, 137, 25);
		...
		singupBtn.setBounds(560, 318, 117, 25);
		...
		lblDontHaveAn.setFont(new Font("Dialog", Font.BOLD, 16));
		lblDontHaveAn.setBounds(337, 315, 229, 29);
